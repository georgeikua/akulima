...
import { z } from "zod"
import { ArrowLeft, Calendar, Clock, Loader2, Upload, User } from "lucide-react"
  ...
  return (
    <div className="container max-w-md mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Respond to the bid request from {bidRequest.buyer.name}</p>
      </div>
        ...
        <>
          <Card className="mb-6">
            <CardHeader className="pb-2">
              ...
              <CardDescription>{bidRequest.quantity}</CardDescription>
            </CardHeader>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field: { value, onChange, ...fieldProps } }) => (
                      <FormItem>
                        <FormLabel>Upload First Image</FormLabel>
                        <FormControl>
                        ...
                        <FormDescription>Upload a clear photo of your produce</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field: { value, onChange, ...fieldProps } }) => (
                      <FormItem>
                        <FormLabel>Upload Second Image (Optional)</FormLabel>
                        <FormControl>
                          <div className="space-y-2">
                            <Input
                              type="file"
